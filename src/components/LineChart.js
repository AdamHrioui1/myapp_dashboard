...
function LineChart(props) {
    let { chartName, StartDate, EndDate, StartDay, EndDay } = props
    ...
    let updateChart = () => {
        ...
        if(getDiffTime(StartDate, EndDate) + 1 < 16) {
        ...
        let obj = ChartObj(x, y, chartTitle, groups)
        setChartData(obj)
    }
